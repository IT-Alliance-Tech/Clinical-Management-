      ...
      <section className="bg-gradient-to-r from-green-700 to-green-600 text-white py-32">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-green-100 max-w-3xl mx-auto">
            Reach out to us for appointments, enquiries,
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-md">
            ...
            <p className="text-gray-600 text-sm mb-6 leading-relaxed">
              Our team is here to assist you with appointments, follow-ups,
              and general medical enquiries. Reach out to us anytime.
            </p>
          ...
          {/* Right Side – Form */}
          <form className="bg-white border border-gray-200 rounded-xl p-6 shadow-md space-y-4">
